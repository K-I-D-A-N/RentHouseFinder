...
export const verifyExternalPayment  = (transactionId) => api.post("/payments/external/verify/", { transaction_id: transactionId });
...
// Promotion payment — separate endpoint from regular booking payments
export const verifyPromotionByTxRef = (txRef)     => api.get(`/listings/promotions/verify/${txRef}/`);
