...
import CustomerPremiumPaymentScreen from "../screens/subscription/CustomerPremiumPaymentScreen";
import ChapaComingSoonScreen from "../screens/subscription/ChapaComingSoonScreen";
import TelebirrPaymentScreen from "../screens/subscription/TelebirrPaymentScreen";
...
function ProfileStackNavigator() {
  return (
    <ProfileStack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <ProfileStack.Screen name="ChapaCheckoutScreen" component={ChapaCheckoutScreen} />
      <ProfileStack.Screen name="PlanSelectionScreen" component={PlanSelectionScreen} />
      <ProfileStack.Screen name="CustomerPremiumPaymentScreen" component={CustomerPremiumPaymentScreen} />
      <ProfileStack.Screen name="ChapaComingSoonScreen" component={ChapaComingSoonScreen} />
      <ProfileStack.Screen name="TelebirrPaymentScreen" component={TelebirrPaymentScreen} />
  ...
  return (
    <Tab.Navigator
      screenOptions={({ route }) => ({
        ...
        tabBarStyle: [
          styles.tabBar,
          { paddingBottom: insets.bottom > 0 ? insets.bottom : 10, paddingTop: 10 },
        ],
