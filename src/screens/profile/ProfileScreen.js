...
export default function ProfileScreen({ navigation }) {
  ...
  const handlePremiumCtaPress = () => {
    navigation.navigate("CustomerPremiumPaymentScreen");
  };
  ...
  return (
    ...
    >
      ...
      <View style={styles.optionsCard}>
        ...
        {!isLandlord && !isPremiumCustomer && (
          <TouchableOpacity style={styles.optionItem} onPress={handlePremiumUpgrade}>
            <View style={[styles.optionIcon, { backgroundColor: "rgba(245,166,35,0.15)" }]}>
              <Ionicons name="star-outline" size={22} color="#f5a623" />
            </View>
            <View style={styles.optionText}>
              <Text style={styles.optionTitle}>Upgrade to Premium</Text>
              <Text style={styles.optionSubtitle}>Unlock premium listings and exclusive content</Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color={colors.textSecondary} />
          </TouchableOpacity>
        )}
      ...
      {!isLandlord && (
        <View style={styles.ctaCard}>
          ...
          <TouchableOpacity style={styles.ctaButton} onPress={handlePremiumCtaPress}>
