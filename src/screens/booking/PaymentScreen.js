...
import { canViewContactInfo } from "../../utils/bookingContact";
...
export default function PaymentScreen() {
  ...
  const ownerPhone = canViewContactInfo(booking) ? getOwnerField(listingSource, "phone") : "";
  const ownerEmail = canViewContactInfo(booking) ? getOwnerField(listingSource, "email") : "";
        ...
        <Section title={t("payment.property")} icon="🏠">
          <View style={styles.propertyRow}>
            ...
            <View style={styles.propertyMeta}>
              ...
              {canViewContactInfo(booking) && !!ownerPhone && ownerPhone !== "Not available" && (
                <Text style={styles.ownerContact}>📞 {ownerPhone}</Text>
              )}
              {canViewContactInfo(booking) && !!ownerEmail && ownerEmail !== "Not available" && (
                <Text style={styles.ownerContact}>✉️ {ownerEmail}</Text>
              )}
              {!canViewContactInfo(booking) ? (
                <Text style={styles.ownerContact}>Contact details appear after booking approval.</Text>
              ) : null}
            </View>
          </View>
        </Section>
