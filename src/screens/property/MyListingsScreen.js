              ...
              <View style={styles.requestContent}>
                <View style={styles.pillRow}>
                  <Text style={styles.pillText}>
                    {item.start_date} → {item.end_date} | Total: {item.total_price ? `${item.total_price.toLocaleString()} ETB` : "-"}
                  </Text>
                </View>
                <View style={styles.pillRow}>
                  <Text style={styles.pillText}>
                    {(item.listing || item.property || item)?.title || (item.listing || item.property || item)?.name || "Untitled"}
                  </Text>
                </View>
